...
<table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"  style="background-color: white">
  <thead style="z-index: 999;  background-color: lightgray;  !important" class="thead-fixed " style="">
    <tr style="background-color: lightgray; z-index: 999; !important">
	    ...
	    <th style="color: black; min-width:180px;">Branch Name</th>
	    <th style="color: black; min-width:180px;">Department</th>
	    <th style="color: black; min-width:180px;">Branch</th>
	    <th style="color: black; min-width:180px;">Employee</th>
	    <th style="color: black; min-width:180px;" class="d-none">ShortName</th>
	    <th style="color: black; min-width:180px;" class="d-none">Type</th>
