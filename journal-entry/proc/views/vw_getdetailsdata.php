...
$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."];
	...
	INNER JOIN OBPL T3 ON T1.BplId = T3.BPLId
...
while (odbc_fetch_row($qry)) 
{
	...
	$U_BranchCode = odbc_result($qry, "U_BranchCode");
		...
		<tr style="background-color: white; "  >
			...
			<td >
				<div class="input-group ">
					<input type="text" class="form-control branch"   style="outline: none; border:none" maxlength="8" readonly 
					value="'.$U_BranchCode.'"/>
				</div>
			</td>
			<td >
			...
			<td >
				<input  type="text" class="form-control matrix-cell department "  style="outline: none; border:none" readonly
				value="'.$ProfitCode.'"/>	
			</td>
			<td >
				<input  type="text" class="form-control matrix-cell department "  style="outline: none; border:none" readonly
			...
			<td class="d-none">
				<input  type="text" class="form-control matrix-cell shortname "  style="outline: none; border:none" readonly
				value="'.$ShortName.'"/>	
			</td>
			<td class="d-none">
				<input  type="text" class="form-control matrix-cell type "  style="outline: none; border:none" readonly
				value=""/>	
			</td>
		</tr>';
   $ctr++;
